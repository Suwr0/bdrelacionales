...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2025 a las 01:02:57
...
(1, 'Electronica', 'Todo tipo de productos electronicos');
...
(1, 'Adolfo lopez mateos', 4800, 'Acueducto', 80058, 'Sinaloa', 'Culiacan', 1);
...
(1, 'Tarjeta de debito', 'Tarjeta de debito pro');
...
(1, 'Audifonos Pro777', 'Los mejores audifonos del mercado 100x100 real no feik', 7777, 1, 1);
...
(1, 'Jose David', 'Lopez Beltran', 'Jodav1818@gmail.com', '3111507433', '2008-01-18', 1);
...
--
ALTER TABLE `ventas`
  ADD CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`metodo_pago_id`) REFERENCES `metodo_pago` (`id`),
  ADD CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`carrito_id`) REFERENCES `carrito` (`id`),
