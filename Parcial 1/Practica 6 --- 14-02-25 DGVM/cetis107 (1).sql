...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2025 a las 01:02:15
...
--
ALTER TABLE `clases`
  ADD CONSTRAINT `Clase_M_a` FOREIGN KEY (`Materia_ID`) REFERENCES `materias` (`id`),
  ADD CONSTRAINT `Clase_M_o` FOREIGN KEY (`Maestro_ID`) REFERENCES `maestros` (`Id`);
COMMIT;
